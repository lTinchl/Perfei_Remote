...
MenuItem MainMenuItems[] = {
	...
	{.General_item_text = "UavInfo",.General_callback = NULL ,.General_SubMenuPage = &SettingsMenuPage,.Tiles_Icon = Image_uavinfo},
...
MenuItem AboutThisDeviceMenuItems[] = {
	...
	{.General_item_text = " SoftWare IIC",.General_callback = NULL,.General_SubMenuPage = NULL,.List_BoolRadioBox = NULL},
	{.General_item_text = "[返回]",.General_callback = OLED_UI_Back,.General_SubMenuPage = NULL,.List_BoolRadioBox = NULL},
